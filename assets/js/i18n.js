...
(function (global) {
  ...
  var UI = {
    ...
    footer_note: {
      ko: '주요 참고문헌: Pavia 외, <em>Introduction to Spectroscopy</em>, 5판(2015); Silverstein 외, <em>Spectrometric Identification of Organic Compounds</em>, 8판(2014); Pretsch 외, <em>Structure Determination of Organic Compounds</em>, 4판(2009); Clayden 외, <em>Organic Chemistry</em>, 2판(2012); Gottlieb 외, <em>J. Org. Chem.</em> 1997, 62, 7512; SDBS(AIST). 부록은 Keeler, <em>Understanding NMR Spectroscopy</em>, 2판(2010)과 Claridge, <em>High-Resolution NMR Techniques in Organic Chemistry</em>, 3판(2016), 물리상수는 CODATA 2018·NIST를 따릅니다. 아홉 문헌 전체와 각 수치의 근거는 <strong>출처</strong> 탭에 있습니다.',
      en: 'Key references: Pavia et al., <em>Introduction to Spectroscopy</em>, 5th ed. (2015); Silverstein et al., <em>Spectrometric Identification of Organic Compounds</em>, 8th ed. (2014); Pretsch et al., <em>Structure Determination of Organic Compounds</em>, 4th ed. (2009); Clayden et al., <em>Organic Chemistry</em>, 2nd ed. (2012); Gottlieb et al., <em>J. Org. Chem.</em> 1997, 62, 7512; SDBS (AIST). The appendices follow Keeler, <em>Understanding NMR Spectroscopy</em>, 2nd ed. (2010) and Claridge, <em>High-Resolution NMR Techniques in Organic Chemistry</em>, 3rd ed. (2016); the physical constants follow CODATA 2018 / NIST. All nine works, and what each number rests on, are listed in the <strong>Sources</strong> tab.'
    },
    footer_disclaimer: {
